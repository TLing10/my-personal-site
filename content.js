...
const SITE_CONTENT = {
    ...
    /* 关于我 · 三张小卡（顺序：热爱 / 旅程 / 性格） */
    smallCards: [
        { icon: "🔬", title: "我的热爱", text: "科学探究、语言学习、艺术与创作，对新鲜事物永远保持胃口。" },
        { icon: "🌏", title: "我的旅程", text: "生于上海，先后就读上海中学国际部与 Canadian Academy，即将北上燕园开启大学新篇章。" },
        { icon: "💫", title: "我的性格", text: "好奇心驱动、乐于带领团队，也在志愿与服务中学会责任。" }
    ],

    /* 兴趣爱好（想增删就在这里加/减一行） */
    skills: [
        { icon: "🌐", name: "三语", note: "英(母语)·中(母语)·日(中级)" },
        { icon: "🥋", name: "跆拳道", note: "黑带 Black Belt" },
        { icon: "💃", name: "舞蹈", note: "拉丁11级·现代8级·芭蕾4级" },
        { icon: "🎸", name: "音乐", note: "尤克里里 · 唱歌" },
        { icon: "📷", name: "滑雪 & 摄影", note: "Snow & Photo" },
        { icon: "🎨", name: "Live2D", note: "角色动画制作" }
    ],

    /* 我的经历（想增删就在这里加/减一行） */
    works: [
        { title: "青少年科技创新大赛 · 三等奖", text: "独立完成数字时代青少年算法素养的实证研究，开展问卷与访谈，撰写 5000 字研究论文及研究日志。", tags: ["科研", "独立研究"] },
        { title: "Rokko Island 英语教学俱乐部 · Leader", text: "与当地日本学校教师协商，策划并带领成员每两周为本地学生开展英语教学，锻炼跨文化沟通与组织力。", tags: ["领导力", "跨文化"] },
        { title: "SciLab · Co-leader", text: "对接大学教师安排参访与体验活动，邀请教授与学生举办知识论坛，组织每月大型活动与夏令营志愿者。", tags: ["组织", "科普"] },
        { title: "志愿服务", text: "参与微笑慈善、数学诊所辅导、新闻组写作、午餐服务与施粥等志愿活动，在持续付出中学会责任与善意。", tags: ["公益", "服务"] }
    ],

    /* 我的历程（按时间顺序，从上到下） */
    timeline: [
        { date: "2015.01 – 2024.06", title: "上海中学国际部", text: "从小学到初中、高中，一路在国际教育体系里成长，打下语言与学力的地基。" },
        { date: "2024.08 – 2026.06", title: "Canadian Academy · IB", text: "修读 IB Diploma，探索数学、生物与物理背后的世界，于 2026 年夏天高中毕业。" },
        { date: "2026年秋 · 新征程", title: "北京大学 · 信息管理", text: "高中毕业后被北京大学录取，即将攻读信息管理专业，开启新的探索旅程 ✦" },
        { date: "荣誉与奖项", title: "科创 & 舞蹈双丰收", text: "第38届上海市青少年科技创新大赛 · 三等奖；武汉CBDF 业余组标准舞（A/B组）与拉丁舞比赛 冠、亚军多项。" }
    ],
