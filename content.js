...
const SITE_CONTENT = {
  ...
  "smallCards": [
    ...
    },
    {
      "icon": "🌏",
      "title": "我的旅程",
      "text": "生于澳大利亚，在上海长大，先后就读上海中学国际部与 Canadian Academy，现已在北京大学开启大学新篇章。"
    },
    {
      "icon": "💫",
      "title": "我的性格",
      "text": "好奇心驱动、乐于带领团队，也在志愿与服务中学会责任，不过大部分时间会比较安静。"
    }
  ],
  "skills": [
    {
  ...
  "works": [
    {
      "title": "广告公司 Account 部门 · 暑期实习",
      "text": "运用 AI 工具开展竞品调研与市场分析，输出调研报告，对接客户，沟通并梳理需求，协助撰写 brief 与方案，同时还负责公司微信公众号内容发布",
      "tags": [
        "实习",
        "AI"
      ]
